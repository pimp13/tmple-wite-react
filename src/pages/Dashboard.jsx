...
//         {/* ---------- Sidebar ---------- */}
//         <aside
//           className={`fixed lg:static inset-y-0 right-0 z-40 w-72 bg-white border-l border-slate-100 flex flex-col transition-transform duration-300 ease-out
...
//                       <GraduationCap size={30} className="text-[#1C3A82]/40" />
...
//   );
  return (
    <div dir="rtl" className="max-h-screen w-full bg-[#F5F8FD] font-[Vazirmatn] text-slate-800">
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Vazirmatn:wght@400;500;600;700;800&display=swap');
        .font-\\[Vazirmatn\\] { font-family: 'Vazirmatn', sans-serif; }
      `}</style>
      ...
      <div className="flex items-center justify-between px-4 py-3 bg-white border-b border-slate-100 lg:hidden sticky top-0 z-30">
        ...
        <div className="flex items-center gap-2">
          <span className="text-sm font-semibold text-[#1C3A82]">آکادمی ایرانسل</span>
          <div className="w-8 h-8 rounded-lg bg-[#1C3A82] flex items-center justify-center">
            <GraduationCap size={16} className="text-white" />
          </div>
        </div>
      ...
      <div className="flex mx-auto">
        {/* ---------- Sidebar ---------- */}
        <aside
          className={`fixed h-[100vh] lg:static inset-y-0 right-0 z-40 w-72 bg-white border-l border-slate-100 flex flex-col transition-transform duration-300 ease-out
          ${sidebarOpen ? "translate-x-0" : "translate-x-full lg:translate-x-0"}`}
        >
          <div className="flex items-center justify-between px-6 py-6">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <p className="text-sm font-bold text-[#1C3A82] leading-tight">آکادمی ایرانسل</p>
                <p className="text-[11px] text-slate-400">یادگیری، هر جا هستی</p>
              </div>
            </div>
            <button
              onClick={() => setSidebarOpen(false)}
          ...
          <div className="p-4 mx-4 mb-4 rounded-2xl bg-[#E5EDF8]">
            <p className="text-xs font-semibold text-[#1C3A82] mb-1">پیشرفت این هفته</p>
            <div className="w-full h-1.5 rounded-full bg-white overflow-hidden mb-2">
              <div className="h-full w-[8%] rounded-full bg-[#1C3A82]" />
            </div>
            <p className="text-[11px] text-slate-500">هنوز شروع نکرده‌ای، همین امروز شروع کن!</p>
          </div>
        ...
        <main className="flex-1 min-w-0">
          ...
          <header className="hidden lg:flex items-center justify-between px-8 py-5">
            <div>
              <p className="text-xs text-slate-400 mb-0.5">خانه</p>
              <h1 className="text-lg font-bold text-slate-800">سلام، محمدرضا 👋</h1>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2.5 pr-3 border-r border-slate-100">
                <div>
                  <p className="text-sm font-semibold text-slate-700 leading-tight">محمدرضا حسینی خالجیری</p>
                  <p className="text-[11px] text-slate-400">دانشجوی آکادمی</p>
                </div>
                <div className="w-10 h-10 rounded-full bg-[#1C3A82] text-white flex items-center justify-center text-sm font-bold">
                  م
          ...
          <div className="px-4 lg:px-8 pb-10 space-y-6 pt-4 lg:pt-0">
            ...
            <section className="relative overflow-hidden rounded-3xl bg-[#1C3A82] px-6 py-10 lg:px-14 lg:py-14">
              ...
              <div className="relative flex flex-col items-center text-center gap-4">
                ...
                <h2 className="text-xl lg:text-2xl font-bold text-white">منتظر اولین دوره‌ات باش!</h2>
                <p className="text-sm lg:text-base text-[#C9D8F2] max-w-md leading-7">
                  به‌زودی دوره‌های جدید اینجا قرار داده می‌شن و می‌تونی یادگیری رو شروع کنی.
                </p>
                <button className="mt-2 px-6 py-3 rounded-xl bg-[#E5EDF8] text-[#1C3A82] text-sm font-bold hover:bg-white transition-colors">
                  مشاهده دوره‌های به‌زودی
                </button>
            ...
            <section>
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-base font-bold text-slate-800">دسترسی سریع</h3>
              </div>
              {/* <SectionMainNav
            ...
            <section>
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-base font-bold text-slate-800">دوره‌های در راه</h3>
                <span className="text-xs text-[#1C3A82] font-medium">به‌زودی تکمیل می‌شود</span>
              </div>
                ...
                {upcomingCourses.map((c) => (
                  ...
                  >
                    ...
                    <div className="p-4">
                      ...
                      <p className="mt-2.5 text-sm font-semibold text-slate-700">{c.title}</p>
                    </div>
                  </div>
                ))}
              </div>
